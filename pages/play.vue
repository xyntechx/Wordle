<template>
    <main class="main">
        ...
        <p v-for="w in triedWords" class="text">{{ w }}</p>

        <input type="text" placeholder="Enter Word" v-model="word" />
        <button @click="play(word)" class="button" v-if="triedWords.length < 6">Check</button>
...
onMounted(() => console.log("word is valid", isValid.value)) //TODO: Random word
